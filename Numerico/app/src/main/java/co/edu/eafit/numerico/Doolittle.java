...
public class Doolittle extends AppCompatActivity {
    ...
    public void doolittle(double[][] A, double[] b) {
        ...
        if (n != l) {
            ...
            for (int k = 0; k < n; k++) {
                ...
                U[k][k] = Double.valueOf(formatter.format(A[k][k] - suma1));
                if (U[k][k] == 0) {
                    Mensaje("Error U[" + k + "," + k + "] is = 0");
                }
                L[k][k] = 1;
                for (int i = k + 1; i < n; i++) {
                    suma2 = 0;
                    ...
                    L[i][k] = Double.valueOf(formatter.format((A[i][k] - suma2) / U[k][k]));
                ...
                for (int j = k + 1; j < n; j++) {
                    ...
                    U[k][j] = Double.valueOf(formatter.format((A[k][j] - suma3)));
    ...
    public void help() {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
        ...
        }).setMessage("The direct factorization method of Doolittle pretends to decompose a matrix A into " +
                ...
                "from zero are unknown, but the elements of the diagonal are one (1), so that L[i][i], " +
                "and with a upper triangular one where the elements different from zero are unknown.\n" +
                "\n" +
