...
public class Jacobi extends AppCompatActivity {
    ...
    double[][] matrizA;
    double[] vectorB;
    double [] datosX_jacobi = new double[Matrix.vectorB.length];
    double tol;
    double lamda;
    double[] datos_iniciales = new double[Matrix.vectorB.length];
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(primeraVez) {
            datosX_jacobi = IterativeMethods.datosX;
            for (int i = 0; i < datosX_strg.length; i++) {
                datos_iniciales[i] = datosX_jacobi[i];
            }
            primeraVez = false;
        }else{
            for (int i = 0; i < datosX_strg.length; i++) {
                datosX_jacobi[i] = datos_iniciales[i];
            }
        }
        ...
        jacobi(matrizA, vectorB, tol, iter, datosX_jacobi, lamda);
    ...
    public void jacobi(double[][] A, double[] b, double tol, int iter, double[] x0, double lamda) {
        ...
        tablitaJacobi(str_n, datosXs_array, str_err);
        count++;
        ...
        tablitaJacobi(str_n, datosXs_array, error);
    ...
    public void tablitaJacobi(String str_n, String[] datosX_strg, String str_err) {
    ...
    public void help() {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                "\n" +
                "The Jacobi method is an iterative algorithm for determining the solutions of a system " +
                "of linear equations.\n" +
                "\n" +
                ...
                "of each one using the cleared equations.\n" +
                "\n" +
                ...
                "than the tolerance.\n" +
                "\n" +
                "One feature of this method is that it works simultaneously and independently, that " +
                "means that in every iteration the whole new approximations are calculated using only the previous ones.\n" +
                "\n" +
